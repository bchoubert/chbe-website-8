    ...
    projects: [
      {
        ...
        icon: "/icon icon-logtrack-logo",
        description:
          "Complete Saas Logistics ERP: GPS Tracking, invoices, recruitment, maintenance...",
      },
    ],
    tasks: [
    ...
    projects: [
      {
        ...
        description:
          "Maplink is both a map component integrated into DICT.fr and a Network and Urban Properties Management Solution",
      },
      {
        name: "GeoSnap",
    ...
    projects: [
      {
        ...
        description:
          "Product range that equips 80% of French hospitals to help them to manage health profiles, pills stock...",
      },
    ],
    tasks: [
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Comment and discuss on job offers have never been so simple",
      },
      {
        name: "Crazy Tips",
        icon: "/icon icon-crazytips-full",
        description:
          "Innovative solution for discussing about real-estate investments and offers",
      },
    ],
    tasks: [
    ...
    projects: [
      {
        ...
        description:
          "The new era of Vessel Management - Fluvial / Inland Vessel ERP",
      },
      {
        name: "SkillMatrix",
        icon: "/icon icon-skillmatrix-logo",
        description:
          "Smart Applicant Tracking System for recruitment companies",
      },
    ],
    tasks: [
    ...
    projects: [
      {
        ...
        icon: "/icon icon-cityzendesk-logo",
        description:
          "The multifunctional app created to ease your daily life in your city and at home",
      },
    ],
    tasks: [
      "Followed test plans",
    ...
    projects: [
      {
        ...
        icon: "/icon icon-ain-full",
        description:
          "Award-winning website that presents in an innovative way data from World War 1",
      },
    ],
    tasks: [
